...
|---|---|---|
| `simple-peer` lỗi với Vite | CJS compatibility | ✅ Đã sửa [vite.config.js](file:///f:/Online-learning-ai/frontend/vite.config.js) |
...
Hiện tại backend chỉ có [authRoutes.js](file:///f:/Online-learning-ai/backend/src/routes/authRoutes.js). Cần bổ sung:
